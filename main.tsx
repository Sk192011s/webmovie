...
// =======================
// 3. MIDDLEWARE & IP LOGIC
// =======================

// Better IP Detection for VPN/Proxy
function getClientIP(c: any): string {
    ...
    for (const header of headers) {
        ...
        if (value) {
            // x-forwarded-for can be "1.1.1.1, 2.2.2.2", take the first one
...
async function checkIP(c: any) {
    ...
    if(ip === "unknown") return false; // Don't ban unknown
...
// =======================
// 5. PRIORITY ROUTES (ADMIN, AUTH, PROFILE) - Must be before dynamic routes
// =======================
