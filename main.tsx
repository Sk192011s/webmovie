                     ...
                     searchTimeout = setTimeout(async () => {
                         try {
                             ...
                             if(data.results.length === 0) {
                                 ...
                                 // 🔥 UI FIX: style="aspect-ratio: 2/3" ကို inline ထည့်ပေးလိုက်တယ် (Tailwind မမိမှာစိုးလို့)
                                 // Link တွေမှာ \ (backslash) ခံထားတာကို မဖျက်ပါနဲ့ (Template String ကြောင့်ပါ)
                                 resultsContainer.innerHTML = data.results.map(m => \`
                                     <a href="/movie/\${m.id}" class="block rounded-xl overflow-hidden bg-zinc-800 relative group shadow-lg" style="aspect-ratio: 2/3; width: 100%;">
                                         <img src="\${m.posterUrl}" class="absolute inset-0 w-full h-full object-cover transition duration-300 group-hover:scale-110" style="width:100%; height:100%;" />
