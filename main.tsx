                                    ...
                                    <script dangerouslySetInnerHTML={{__html: `
                                        ...
                                        function extractLinks() {
                                            try {
                                                ...
                                                if (!foundLinks || foundLinks.length === 0) { alert("No links found!"); return; }
                                        ...
                                        function clearEpisodes() { if(confirm('Clear all?')) document.getElementsByName('episodeList')[0].value = ''; }
                                    `}} />
                                </div>
