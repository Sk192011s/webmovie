        ...
        async function loadMoreMovies(category) {
            ...
            try {
                ...
                data.movies.forEach(m => {
                    ...
                    // Check if Uncensored for Wide Card
...
// MOVIE DETAIL (RESTORED SEASON GROUPING)
