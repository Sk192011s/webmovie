    ...
    <head>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             // 🔥 RESOLVE FIRST PLAYER (Fixes Redirects + 2-Step Links)
             window.loadPlayer = async function(content, type, movieId, title, poster, btnElement) {
                ...
                // Show local loader while resolving URL
                if(loader) loader.style.display = 'flex';

                let finalUrl = content;

                // 3. Resolve URL (Token -> Real Link)
                if (type === 'direct') { 
                    try { 
                ...
                // 4. Player Construction (Smart Fallback)
                if (type === 'embed' || finalUrl.includes('<iframe') || finalUrl.includes('proxy.avotc.tk')) { 
                    ...
                    // Iframe load ဖြစ်မဖြစ် မသိနိုင်လို့ 2s နေရင် loader ဖျောက်မယ်
