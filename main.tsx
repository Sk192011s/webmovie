...
app.get("/profile", async (c) => { 
    ...
    const plans = [
        { name: "LuGyi Apk 1Month+15Days Goldflix", price: "700 Ks", days: 30, features: ["Unlock All Movies", "Download Access", "Adult And All Uncensored"] },
        { name: "LuGyi Apk 3Month+45Days Goldflix", price: "1,500 Ks", days: 90, popular: true, features: ["Unlock All Movies", "Download Access", "Adult And All Uncensored", "Fast Servers"] },
        { name: "LuGyi Apk 5Month+75Days Goldflix", price: "2,200 Ks", days: 150, features: ["Unlock All Movies", "Download Access", "Adult And All Uncensored", "Fast Servers"] },
        { name: "LuGyi Apk 1year+175Days Goldflix", price: "5,000 Ks", days: 365, features: ["Unlock All Movies", "Download Access", "Adult And All Uncensored", "Fast Servers"] }
    ]; 
    ...
    return c.html(
      <Layout user={user} lang={lang} activeTab="me">
        <div class="p-4 max-w-4xl mx-auto space-y-6">
            ...
            <div>
                <h3 class="font-bold text-xl text-white mb-4 flex items-center gap-2"><i class="fa-solid fa-layer-group text-blue-500"></i> Lugyi Apk and Goldflix Plans</h3>
