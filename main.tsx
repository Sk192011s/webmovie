...
app.get(ADMIN_ROUTE + "/dashboard", adminGuard, async (c) => { 
    ...
    if (editId) {
        // 1. လက်ရှိပြထားတဲ့ List ထဲမှာ ရှာကြည့်မယ်
        editMovie = movies.find(m => m.id === editId);
        
        // 2. မတွေ့ရင် (ဥပမာ Search လုပ်ပြီးမှ Edit နှိပ်လိုက်လို့ List ပြောင်းသွားရင်)
        // Database ထဲကနေ တိုက်ရိုက် လှမ်းယူမယ်
        if (!editMovie) {
...
app.post("/admin/movie/save", adminGuard, async (c) => {
    ...
    // 🔥 FIX: "Move to Top" အမှန်ခြစ်ခဲ့ရင် (on ဖြစ်နေရင်) အချိန်အသစ်ယူမယ်
    // မခြစ်ခဲ့ရင် အရင်အချိန် (body.createdAt) အတိုင်းပဲ ပြန်ထားမယ်
    ...
    const movie: Movie = {
        ...
        createdAt: newCreatedAt, // 🔥 ပြင်ထားသော အချိန်ကို ထည့်မယ်
