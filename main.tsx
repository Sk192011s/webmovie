...
const i18n: any = {
    en: {
        ...
        see_all: "View All", views: "Views", dl_help: "Download Guide",
    ...
    return c.html(
        <Layout title="Admin Dashboard" isAdmin={true}>
            <div class="p-4 bg-black min-h-screen font-sans text-sm">
                ...
                {/* 8. Tab Content: Users (Full Features) */}
                <div id="tab-users" class="tab-content">
                    <div class="max-w-4xl mx-auto space-y-6">
                        ...
                        <div class="bg-[#111] p-6 rounded-lg border border-purple-500/30 shadow-xl h-fit relative overflow-hidden">
                            ...
                            <p class="text-xs text-gray-500 mb-4 relative z-10">User အားလုံး (Free ရော VIP ရော) ကို ရက်ထပ်ပေါင်းပေးမည်။ (ဥပမာ - Server Error ဖြစ်လို့ လျော်ကြေးပေးခြင်း)</p>
