           ...
           <div class="bg-[#1f1f1f] p-6 rounded-xl border border-zinc-700 w-11/12 max-w-sm text-center relative shadow-2xl modal-enter">
              ...
              <div class="text-left text-xs text-gray-300 space-y-3 mb-6 bg-black/40 p-3 rounded-lg border border-zinc-800">
                   <p>
                       ...
                       Movieမှာ <span class="text-white font-bold bg-zinc-700 px-1 rounded">DL</span> ခလုတ်များ ပါရှိပါက  နှိပ်၍ တိုက်ရိုက်ဒေါင်းယူနိုင်ပါသည်။ မပါလျှင် နည်း၂ကို သုံးပါ
                   </p>
...
app.get("/profile", async (c) => { 
    ...
    const plans = [
        { name: "1 Month", price: "700 Ks", days: 30, features: ["Unlock Movies", "Direct Download"] },
        { name: "3 Months", price: "1,500 Ks", days: 90, popular: true, features: ["Best Value", "Fast Servers"] },
        { name: "5 Months", price: "2,200 Ks", days: 150, features: ["Long Term", "VIP Support"] },
        { name: "1 Year", price: "5,000 Ks", days: 365, features: ["Legend Status", "All Access"] }
    ]; 
        ...
        <div class="p-4 max-w-2xl mx-auto space-y-5 pb-20">
            ...
            <div class="bg-[#1f1f1f] p-5 rounded-2xl border border-zinc-800 relative overflow-hidden">
                 ...
                 <h3 class="font-bold text-gray-300 text-sm mb-3 flex items-center gap-2 relative z-10">
                    <i class="fa-solid fa-gift text-yellow-500"></i> Redeem Code
                 </h3>
            ...
            <div>
                <h3 class="font-bold text-white mb-4 flex items-center gap-2 text-sm uppercase tracking-wider text-gray-500">
                    <i class="fa-solid fa-gem text-blue-500"></i> Choose a Plan
                </h3>
                <div class="grid grid-cols-2 gap-3">
                    {plans.map(p => (
