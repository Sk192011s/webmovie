        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // 🔥 UPDATED PLAYER FUNCTION (No Resume & Fix Double Click)
             window.loadPlayer = async function(content, type, movieId, title, poster, btnElement) {
                ...
                // 2. Player အဟောင်းကို ချက်ချင်းရှင်းမယ် (Fix Double Click)
                if(container) container.innerHTML = ''; 
                if(cover) cover.style.display = 'none';
                if(container) container.style.display = 'block'; // Player ကို ချက်ချင်းဖော်မယ်
                ...
                if (type === 'embed' || finalUrl.includes('<iframe')) { 
                    ...
                    // Resume Code တွေကို ဖျက်လိုက်ပါပြီ
                ...
                // 5. Player ကို ထည့်မယ်
                container.innerHTML = htmlContent; 

                // 6. Video Events (Loading & Autoplay)
                ...
                if(video) { 
                    ...
                    video.addEventListener('error', async () => { 
                        // Error တက်ရင် Reload လုပ်ကြည့်မယ်
                    ...
                    // Force Play
                    try { await video.play(); } catch(e) { console.log("Autoplay prevented by browser"); }
                }
