    ...
    <head>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             // 🔥 UX: NATIVE PLAYER (BROWSER DEFAULT) WITH NEXT EPISODE
             window.loadPlayer = async function(content, type, movieId, title, poster, btnElement) {
                ...
                // Direct Link ဖြစ်ရင် URL Resolve လုပ်ခြင်း
                if (type === 'direct') { 
                    try { 
                ...
                // 🔥 NATIVE VIDEO TAG (Browser မူရင်း)
                // controlsList="download" က Chrome မှာ Download ခလုတ်ပေါ်စေဖို့ ကူညီပေးပါတယ်
                ...
                if(btnElement && btnElement.dataset.next) {
                    ...
                    // Click နှိပ်ရင် နောက်တစ်ပိုင်းကူး
