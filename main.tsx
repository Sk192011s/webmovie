...
// 🔥 POWERFUL IP FINDER (ENV + HEADER FALLBACK)
...
// 🔥 LOGIN ROUTE (🔥 IP BLACKLIST CHECK 🔥)
app.post("/login", async (c) => { 
    const ip = getClientIp(c);

    // 1. IP Ban Check
    if (await isIpBanned(ip)) {
        return c.text("ACCESS DENIED: Your IP has been banned due to suspicious activity.", 403);
    }
...
// 🔥 SIGNUP ROUTE (🔥 IP BLACKLIST CHECK 🔥)
