...
const Layout = (props: { children: any; title?: string; user?: User | null; hideNav?: boolean; announcement?: string; isAdmin?: boolean }) => {
  ...
  <html lang="my">
    <head>
      ...
      {/* 🔥 ARTPLAYER & HLS.JS (For Better Video Support) 🔥 */}
      ...
      <style>{`
        ...
        * { user-select: none; -webkit-user-select: none; }
        ...
        /* Artplayer Fixes */
        .art-video-player { z-index: 10 !important; }
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             // 🔥 NEW: ARTPLAYER INTEGRATION (FIXED DOWNLOAD & M3U8) 🔥
             window.loadPlayer = async function(content, type, movieId, title, poster) {
                ...
                if (window.art) { window.art.destroy(false); window.art = null; }
                ...
                window.art = new Artplayer({
                    ...
                    autoPlayback: true,
                    airplay: true,
                    theme: '#E50914', // Red Theme
                    lang: 'en',
                    // Disable Mobile Gestures (Swipe for volume/brightness)
                    mobileCombs: false, 
                    ...
                    controls: [
                        {
                            name: 'download',
                            position: 'right',
                            html: '<i class="fa-solid fa-download" style="font-size: 14px; margin-right: 5px;"></i>',
