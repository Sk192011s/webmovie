    ...
    <head>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             // 🔥 2. PLAYER LOGIC (MediaFire + Native Controls)
             window.loadPlayer = async function(content, type, movieId, title, poster, btnElement) {
                ...
                // Video HTML Construction (String Concatenation to avoid JSX errors)
                ...
                videoHtml += '<div id="error-msg" class="hidden absolute inset-0 flex items-center justify-center bg-black/80 text-white text-xs text-center p-4">';
                videoHtml += '<p class="text-red-500 font-bold mb-2">Video Error / Loading Failed</p>';
                videoHtml += '<a href="' + finalUrl + '" target="_blank" class="bg-blue-600 px-4 py-2 rounded-lg text-white font-bold">Click to Watch Directly</a>';
                videoHtml += '</div>';
