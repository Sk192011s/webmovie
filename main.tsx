                    ...
                    <div class="h-scroll-section custom-scroll">
                        {catMovies.map(m => (
                            <a href={`/movie/${m.id}`} class="h-scroll-item block relative bg-[#1f1f1f] rounded-xl overflow-hidden w-28 flex-shrink-0 active:scale-95 transition-transform movie-card group">
                                <div class="aspect-[2/3] w-full relative overflow-hidden"><img src={m.posterUrl} loading="lazy"class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition duration-500" /><div class="absolute top-1 right-1 bg-yellow-500 text-black text-[8px] font-bold px-1.5 py-0.5 rounded shadow">HD</div></div>
      ...
      <div id="video-player" class="w-full h-full hidden"></div>
           ...
           <div class="p-6">
               <div class="flex justify-between items-start mb-3">
                   <h1 class="text-3xl font-black text-white leading-tight flex-grow pr-4">{movie.title}</h1>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex gap-2 w-full">
                                        <select name="category" class="input-box flex-grow min-w-0 bg-black border-zinc-700">
                                            {["Movies","Series","Animation","Adult","All Uncensored"].map(o => <option selected={editMovie?.category===o}>{o}</option>)}
                                        </select>
