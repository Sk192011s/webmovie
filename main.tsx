    ...
    <Layout user={user} announcement={config.showAnnouncement ? config.announcement : undefined} lang={lang} activeTab="home">
        ...
        {shouldShowPopup && (
          <div id="promo-popup" class="fixed inset-0 z-[200] bg-black/90 hidden items-center justify-center backdrop-blur-sm p-4">
              <div class="relative w-full max-w-sm bg-[#1f1f1f] rounded-2xl overflow-hidden shadow-2xl border border-yellow-500/30 modal-enter">
                  
                  {/* Close (X) - Just close for this session */}
                  ...
                  <a href={config.popupLink || "#"}>
                      <img src={config.popupImage} class="w-full h-auto object-cover max-h-[400px]" />
                  </a>

                  <div class="p-4 bg-[#1f1f1f]">
                      <a href={config.popupLink || "#"} class="block w-full bg-gradient-to-r from-yellow-600 to-yellow-500 text-black font-bold text-center py-3 rounded-xl shadow-lg hover:brightness-110 transition uppercase tracking-wider text-sm">
                          {config.popupBtnText || "View Details"} <i class="fa-solid fa-arrow-right ml-1"></i>
                      </a>
                      
                      {/* Don't show again - Hide for 24 Hours */}
                      <button onclick="closePopup(true)" class="block w-full text-center text-[10px] text-gray-500 mt-3 hover:text-white underline">
            ...
            <div class="p-4 bg-black min-h-screen font-sans text-sm">
                ...
                <div id="tab-config" class="tab-content">
                    <div class="max-w-xl mx-auto bg-[#111] p-6 rounded-2xl border border-zinc-800 space-y-8 shadow-xl">
                        ...
                        {/* 2. POPUP ADS (ကြော်ငြာ Popup) - NEW ADDITION 🔥 */}
...
app.post("/admin/config/popup", adminGuard, async (c) => { 
    ...
    await kv.set(["config"], { 
        ...
        popupTarget: body['popupTarget'], // 👈 ဒါလေး ပေါင်းထည့်လိုက်ပါတယ်
