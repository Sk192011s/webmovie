      ...
      <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-sm glass rounded-3xl p-8 shadow-2xl">
          <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-black tracking-tight">AI Synopsis Tool</h1>
...
app.get(`${ADMIN_ROUTE}/dashboard`, requireAdmin, (c) => {
  return c.html(
    layout(
      "AI Synopsis Dashboard",
      `
      <div class="min-h-screen p-4 md:p-8">
        <div class="max-w-4xl mx-auto">
          <div class="flex items-center justify-between mb-6">
            <div>
              <h1 class="text-3xl md:text-4xl font-black tracking-tight">AI Synopsis / Translation</h1>
              <p class="text-gray-400 text-sm mt-2">English / Japanese / other text → Burmese rewrite</p>
            </div>
            <a href="${ADMIN_ROUTE}/logout" class="btn-dark">
            ...
            <div class="grid gap-4">
              ...
              <div>
                ...
                <select id="mode" class="input-box">
                  <option value="story">ပုံပြင်ပြောသလို Burmese synopsis</option>
                  <option value="translate">တိုက်ရိုက်ဘာသာပြန်</option>
                  <option value="soft">ညင်ညင်သာသာ rewrite</option>
                </select>
              </div>
...
app.post(`${ADMIN_ROUTE}/api/generate`, requireAdmin, async (c) => {
  const body = await c.req.parseBody();
...
`,
      `
Rewrite the following into Burmese in a vivid storytelling style.
...
- Smooth, emotional, readable
- 2 to 5 sentences
- Keep original meaning as much as possible
- Output only final Burmese text
`,
      `
...
`,
    ...
    soft: [
      `
Rewrite the following into Burmese in a softer, more readable style.
...
- Burmese Unicode only
- Keep the original meaning as much as possible
- Make the wording softer and smoother
- No explanation
- Output only the Burmese result
`,
      `
Translate the following into Burmese naturally.
