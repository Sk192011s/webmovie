    ...
    return c.html(
     ...
     <form action="/profile/topup" method="post" class="space-y-4">
        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            {/* KPAY OPTION (LOGO IMAGE UPDATED) */}
            <label class="cursor-pointer relative group">
                ...
                <div class="p-4 rounded-xl bg-black/50 border border-zinc-700 peer-checked:border-blue-500 peer-checked:bg-blue-900/10 transition hover:bg-zinc-800 group-active:scale-95 flex items-center gap-4">
                    ...
                    {/* 🔥 KBZ Logo Image */}
                    <img 
                        src="https://is1-ssl.mzstatic.com/image/thumb/Purple126/v4/05/85/43/05854353-8566-d360-1536-23588970868f/AppIcon-0-0-1x_U007emarketing-0-0-0-7-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/512x512bb.jpg" 
                        class="w-12 h-12 rounded-lg object-cover shadow-sm border border-white/10 flex-shrink-0" 
                    />
                    ...
                    <div class="absolute top-4 right-4 text-blue-500 opacity-0 peer-checked:opacity-100 transition">
                        <i class="fa-solid fa-circle-check text-xl"></i>
                    </div>
                </div>
            </label>

            {/* WAVE PAY OPTION (LOGO IMAGE UPDATED) */}
            <label class="cursor-pointer relative group">
                ...
                <div class="p-4 rounded-xl bg-black/50 border border-zinc-700 peer-checked:border-yellow-400 peer-checked:bg-yellow-900/10 transition hover:bg-zinc-800 group-active:scale-95 flex items-center gap-4">
                    ...
                    {/* 🔥 Wave Logo Image */}
                    <img 
                        src="https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/b2/24/76/b2247656-749e-1144-486d-6258416d2f3a/AppIcon-0-0-1x_U007emarketing-0-0-0-7-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/512x512bb.jpg" 
                        class="w-12 h-12 rounded-lg object-cover shadow-sm border border-white/10 flex-shrink-0" 
                    />
                    ...
                    <div class="absolute top-4 right-4 text-yellow-400 opacity-0 peer-checked:opacity-100 transition">
                        <i class="fa-solid fa-circle-check text-xl"></i>
                    </div>
                </div>
            </label>
