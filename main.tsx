        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             window.loadPlayer = async function(content, type, movieId, title, poster) {
                ...
                if (type === 'embed' || finalUrl.includes('<iframe')) { 
                    // Sandbox ထည့်ထားသော အပိုင်း
                    htmlContent = finalUrl.includes('<iframe') 
                        ? finalUrl.replace('></iframe>', ' sandbox="allow-forms allow-scripts allow-same-origin allow-presentation"></iframe>') 
                        : '<iframe src="'+finalUrl+'" width="100%" height="100%" frameborder="0" allowfullscreen sandbox="allow-forms allow-scripts allow-same-origin allow-presentation"></iframe>';
