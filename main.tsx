...
// *** ASSET LINKS (FOR URL BAR REMOVAL) ***
app.get("/.well-known/assetlinks.json", (c) => c.json([{
  "relation": ["delegate_permission/common.handle_all_urls"],
  "target": {
    "namespace": "android_app",
    "package_name": "dev.deno.goldflix_stream.twa", // မိတ်ဆွေပေးထားသော Package Name
           ...
           <div class="p-4">
               ...
               {premium && movie.category !== "Series" && (
                   <div class="flex flex-col gap-2 mb-6">
                       ...
                       <div id="download-help" class="hidden bg-zinc-900 border border-yellow-600/50 rounded-lg p-3 text-xs text-gray-300 space-y-2 mt-1">
                           <p><strong class="text-yellow-500">နည်းလမ်း (၁)</strong><br/>DL ခလုတ်ပါလျှင် နှိပ်၍ ဒေါင်းပါ။</p>
                           <hr class="border-zinc-700"/>
                           <p><strong class="text-yellow-500">နည်းလမ်း (၂)</strong><br/>Video ဖွင့်ပြီး ညာဘက်အောက်ထောင့်က အစက် ၃ စက်နှိပ်ပြီး Download ရွေးပါ။</p>
                       </div>
                   </div>
               )}
               ...
               {related.length > 0 && (
                   <div class="pt-4 border-t border-zinc-800">
                       ...
                       <div class="h-scroll-section custom-scroll">
                           {related.map(m => (
                               <a href={`/movie/${m.id}`} class="h-scroll-item block relative bg-[#1f1f1f] rounded overflow-hidden"><img src={m.posterUrl} /><div class="p-1.5"><h3 class="text-[10px] font-bold truncate text-white">{m.title}</h3></div></a>
                           ))}
                       </div>
                   </div>
               )}
