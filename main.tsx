           ...
           <div class="p-6">
               ...
               {premium && (
                   <div class="flex flex-col gap-3 mb-8">
                       ...
                       <button onclick="toggleHelp()" class="w-fit mx-auto text-xs text-yellow-500 hover:text-yellow-400 flex items-center gap-1 mt-2 font-bold transition-colors">
                           <i class="fa-solid fa-circle-question"></i> {t.dl_help}
                       </button>
                       <div id="download-help" class="hidden bg-zinc-900 border border-yellow-600/30 rounded-xl p-4 text-xs text-gray-300 space-y-3 mt-1">
                           <p>
                               <strong class="text-yellow-500">နည်းလမ်း (၁) - Direct Download</strong><br/>
                               အပေါ်က <span class="text-white font-bold">DL</span> ခလုတ်များကို နှိပ်၍ တိုက်ရိုက်ဒေါင်းယူနိုင်ပါသည်။
                           </p>
                           <hr class="border-zinc-700"/>
                           <p>
                               <strong class="text-yellow-500">နည်းလမ်း (၂) - Video Player မှတဆင့်</strong><br/>
