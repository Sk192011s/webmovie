                  ...
                  {sliderMovies.map((m, idx) => (
                      <div class={`slide ${idx === 0 ? 'active' : ''}`}>
                          ...
                          <div class="absolute bottom-6 left-4 right-4">
                              <span class="bg-yellow-500 text-black text-[10px] px-2 py-0.5 rounded font-bold uppercase tracking-wider mb-2 inline-block shadow">{t.featured}</span>
                              <h1 class="text-xl md:text-3xl font-black text-white drop-shadow-md truncate leading-tight">{m.title}</h1>
