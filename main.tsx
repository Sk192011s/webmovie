...
app.get("/profile", async (c) => { 
    ...
    const plans = [
        { name: "LuGyi Apk 1Month + Gold 15Day", price: "700 Ks", days: 30, features: ["Unlock All Movies", "Direct Download"] },
        { name: "LuGyi Apk 3Month + Gold 45Day", price: "1,500 Ks", days: 90, popular: true, features: ["Unlock All Movies", "Direct Download"] },
        { name: "LuGyi Apk 5Month + Gold 75Day", price: "2,200 Ks", days: 150, features: ["Unlock All Movies", "Direct Download"] },
        { name: "LuGyi Apk 1Year + Gold 180Day", price: "5,000 Ks", days: 365, features: ["Unlock All Movies", "Direct Download"] }
    ]; 
