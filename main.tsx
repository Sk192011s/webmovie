      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        async function loadMoreMovies(category) { 
            ...
            for(let i=0; i<6; i++) {
                ...
                el.className = 'block rounded-2xl overflow-hidden aspect-[2/3] img-skeleton mt-2';
            ...
            try { 
                ...
                data.movies.forEach(m => { 
                    ...
                    el.innerHTML = \`
                        <div class="relative \${isWide ? 'aspect-video' : 'aspect-[2/3]'} overflow-hidden rounded-2xl shadow-lg img-skeleton">
                        ...
                        <div class="h-scroll-section">
                            {catMovies.map(m => (
                                <a href={`/movie/${m.id}`} class="h-scroll-item wide block group relative mb-4">
                                    <div class="aspect-video w-full relative overflow-hidden rounded-2xl shadow-lg img-skeleton">
                    ...
                    <div class="h-scroll-section custom-scroll">
                        {catMovies.map(m => (
                            <a href={`/movie/${m.id}`} class="h-scroll-item block w-28 flex-shrink-0 group relative mb-4">
                                <div class="aspect-[2/3] w-full relative overflow-hidden rounded-2xl shadow-lg img-skeleton">
                    ...
                    {results.map(m => {
                        ...
                        return (
                            <a href={`/movie/${m.id}`} class={`block group relative ${isWide ? 'col-span-3' : ''}`}>
                                <div class={`${isWide ? "aspect-video" : "aspect-[2/3]"} relative overflow-hidden rounded-2xl shadow-lg img-skeleton`}>
