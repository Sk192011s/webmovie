    ...
    <head>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             // 🔥 (အသစ်ထည့်ရန်) Back Key နှိပ်ပြီး ပြန်လာရင် Modal ကို အလိုအလျောက် ပိတ်ပေးမည့်ကုဒ်
             window.addEventListener('pageshow', (event) => {
                 // Cache ကနေ ပြန်ပွင့်လာရင် (Back နှိပ်လာရင်)
                 if (event.persisted) {
                     window.location.reload(); // Page ကို Refresh လုပ်လိုက်မယ် (ဒါမှ ဝယ်ပြီးသား state နဲ့ ပြန်ပေါ်မှာ)
                 }
                 // Modal ဖွင့်ထားမိရင် ပြန်ပိတ်မယ်
...
app.post("/admin/movie/save", adminGuard, async (c) => { 
    ...
    // 🔥 4K Porns (Auto System) - Drafts & Live အကုန်စစ်မည်
    if (category === "4K Porns" && body["mode"] === "create" && !title) {
        price = 50; 
        
        // ၁. Live တွင်ရှိသော နောက်ဆုံးနံပါတ်ကို ရှာသည်
        let maxNum = 0;
        ...
        // ၂. Drafts ထဲတွင်ရှိသော နံပါတ်များကိုပါ လိုက်ရှာသည် (ဒါမှ Title မထပ်မှာပါ)
