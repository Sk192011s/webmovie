...
const Layout = (props: { children: any; title?: string; user?: User | null; hideNav?: boolean; announcement?: string; isAdmin?: boolean }) => {
  // CSS Logic: Admin မဟုတ်ရင် touch-callout နဲ့ pointer-events ကိုပိတ်မယ်
  const protectCSS = props.isAdmin ? "" : `
    * { -webkit-touch-callout: none !important; }
    img { pointer-events: none; }
  `;
  
  // JS Logic: Admin မဟုတ်ရင် Right Click ပိတ်မယ်
  ...
  <html lang="my">
    <head>
      ...
      <style>{`
        ...
        * { user-select: none; -webkit-user-select: none; }
        ...
        ${protectCSS} /* Added Protection CSS */
        ...
        /* SPINNER FIX: FORCE HIDDEN BY DEFAULT */
        ...
        #page-loader.active { display: flex; } /* Only show when active class is added */
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ${protectJS} // Inject Protection JS if not Admin
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             document.body.addEventListener('click', (e) => {
                ...
                if (link) {
                    ...
                    // Don't show loader for download links or # links
    ...
    <body>
      {/* 1. Page Loader: Fixed to be Hidden by default */}
           ...
           <div class="p-4">
               ...
               {premium && (
                   <div class="flex flex-col gap-2 mb-6">
                        ...
                        {/* Download Buttons with Confirmation Box */}
                        {movie.category !== "Series" && (
                        ...
                        {/* Help Section (Moved Outside 'Not Series' check) */}
    ...
    return c.html(
        <Layout title="Admin" isAdmin={true}>
            <div class="p-4 bg-zinc-900 min-h-screen">
                ...
                {/* TAB 1: MOVIES - ADDED FILE SIZE INPUT */}
