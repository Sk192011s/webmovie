...
interface Movie {
  ...
  episodes?: Episode[];
  linkType: "direct" | "embed"; downloadUrl?: string; downloadUrl2?: string;
  createdAt: number;
}
interface User {
...
// =======================
// 5. ESSENTIAL ROUTES (MANIFEST, SW, ASSETS)
// =======================
...
// UPDATED SERVICE WORKER (NETWORK FIRST STRATEGY TO FIX CACHE)
app.get("/service-worker.js", (c) => c.text(`
  self.addEventListener('install', (e) => { self.skipWaiting(); });
  self.addEventListener('activate', (e) => { e.waitUntil(self.clients.claim()); });
  self.addEventListener('fetch', (e) => { 
      if (e.request.mode === 'navigate') {
          // Network First, fallback to Cache (Fixes "Login" sticking)
...
// =======================
// 6. PUBLIC ROUTES (LOGIN/SIGNUP/PROFILE - MOVED UP FOR PRIORITY)
// =======================
