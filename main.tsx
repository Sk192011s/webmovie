...
app.post("/admin/api/generate-desc", adminGuard, async (c) => {
    ...
    // AI ကို မှာကြားချက် (မြန်မာလို ရေးခိုင်းထားသည်)
    ...
    try {
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${apiKey}`, {
            ...
            body: JSON.stringify({
                ...
                // 👇 Safety Setting တွေကို ပိတ်လိုက်ပါပြီ (Weapons လို နာမည်တွေ လက်ခံအောင်)
                safetySettings: [
        ...
        if (!result) return c.json({ error: "AI returned empty text (Blocked or No Data)." });
