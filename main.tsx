...
// 🔥 AI Description Generator Route (Updated to Gemini 2.0 Flash)
app.post("/admin/api/generate-desc", adminGuard, async (c) => {
    ...
    try {
        // 👇 ဒီနေရာမှာ 'gemini-2.0-flash' ကို ပြောင်းသုံးလိုက်ပါပြီ (မိတ်ဆွေ List ထဲမှာ ရှိပါတယ်)
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${apiKey}`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                contents: [{ parts: [{ text: prompt }] }],
                // Safety Settings (Block မခံရအောင် ပိတ်ထားသည်)
                safetySettings: [
