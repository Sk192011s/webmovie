    ...
    try {
        ...
        for (let i = 0; i < movies.length; i += BATCH_SIZE) {
            ...
            await Promise.all(chunk.map(async (m, idx) => {
                ...
                // BlueTV သို့မဟုတ် BlueTV Pro ပါရင် Gold Flix လို့ပြောင်းမယ် (စာလုံးအကြီးအသေးမရွေး)
                if (desc) {
                ...
                const movieData: Movie = {
                    ...
                    coverUrl: cover, 
                    category: category, 
                    description: desc, // ပြင်ပြီးသား Description ဝင်သွားမယ်
                    tags: title,
        ...
        return c.redirect(ADMIN_ROUTE + "/dashboard?success=Imported " + totalCount + " Movies (Rebranded to Gold Flix)");
