    ...
    return c.html(
      <Layout user={user} lang={lang} activeTab="me">
        <div class="p-4 max-w-2xl mx-auto space-y-5 pb-20">
            ...
            {/* LOGOUT */}
            <a href="/logout" class="flex items-center justify-center w-full gap-2 text-red-500 font-bold text-xs py-4 hover:text-red-400 transition opacity-60 hover:opacity-100">
