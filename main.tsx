    ...
    <head>
      ...
      <style>{`
        ...
        * { user-select: none; -webkit-user-select: none; }
        ...
        .nav-item { display: flex; flex-direction: column; items-center; justify-content: center; font-size: 10px; color: #666; transition: 0.3s; }
                   ...
                   <div class="flex flex-col gap-3 mb-8">
                        ...
                        {movie.category !== "Series" && (
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <button onclick={`shareMovie('${movie.title}')`} class="w-full bg-zinc-800 text-white font-bold py-3 px-2 rounded-xl flex items-center justify-center gap-2 border border-zinc-700 active:scale-95 transition hover:bg-zinc-700 text-xs">
                                    <i class="fa-solid fa-share-nodes"></i> {t.share}
                                </button>
                                {/* DL Button Placeholder if needed, currently DL section is below */}
                            </div>
                        )}
