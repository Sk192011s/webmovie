...
// ADMIN DASHBOARD (FULL COMPLETE VERSION)
                    ...
                    <div class="flex flex-col lg:grid lg:grid-cols-3 gap-6">
                        ...
                        <div class={`lg:col-span-1 p-5 rounded-2xl border h-fit lg:sticky lg:top-4 z-10 w-full max-w-[100vw] overflow-hidden shadow-xl transition-colors ${editMovie ? 'bg-blue-900/20 border-blue-500/50' : 'bg-[#111] border-zinc-800'}`}>
                            ...
                            <form action="/admin/movie/save" method="post" class="space-y-4 text-sm w-full">
                                ...
                                {/* 👇👇👇 MAGIC TOOLS: COMPLETE VERSION (TOOL 1 + TOOL 2) 👇👇👇 */}
                                <div class="bg-zinc-800 p-3 rounded-xl mb-2 border border-zinc-700">
                                    ...
                                    {/* COMMON SETTINGS (နှစ်ခုလုံးအတွက် သုံးမည့် ဆက်တင်များ) */}
                                    ...
                                    {/* ✅ TOOL 1: SEQUENCE GENERATOR (နံပါတ်စဉ်လိုက် ပွားမည့်ဟာ) */}
                                    ...
                                    {/* ✅ TOOL 2: BULK EXTRACTOR (အမှိုက်စာလုံးများ ရှင်းထုတ်မည့်ဟာ) */}
                                    <div class="border-t border-zinc-700 pt-2">
                                        <p class="text-[9px] text-gray-400 mb-1">Tool 2: Bulk Extractor (For Database/Messy Files)</p>
                                        <textarea id="bulk-text" placeholder="Paste database text here..." class="input-box text-[10px] bg-black border-zinc-600 h-16 w-full mb-2"></textarea>
                                    ...
                                    {/* JAVASCRIPT LOGIC (FOR BOTH TOOLS) */}
                                    <script dangerouslySetInnerHTML={{__html: `
                                        // FUNCTION FOR TOOL 1
                                        ...
                                        // FUNCTION FOR TOOL 2 (Binary Cleaning Included)
                                        function extractLinks() {
                                            try {
                                                ...
                                                // 1. Clean Binary/Symbols
                                                rawText = rawText.replace(/[^\\x20-\\x7E\\s]/g, " ");
                                                ...
                                                alert(\`Success! Extracted \${addedCount} unique links.\`);
