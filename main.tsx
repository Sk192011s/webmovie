...
interface Movie {
  ...
  category: "Movies" | "Series" | "Animation" | "Adult" | "All Uncensored"; 
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex gap-2 w-full">
                                        <select name="category" class="input-box flex-grow min-w-0 bg-black border-zinc-700">
                                            {["Movies","Series","4K Movies","Animation","Adult","All Uncensored", "Myanmar and Asian"].map(o => <option selected={editMovie?.category===o}>{o}</option>)}
                                        </select>
