...
function getClientIp(c: any): string {
    // 1. Try Deno Connection Info (Most Reliable on Deploy)
    // Deno.serve passes info as the second arg, which Hono captures in c.env
    try {
...
// 🔥 LOGIN ROUTE (Fixed IP + Fixed Salt)
