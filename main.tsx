...
app.get("/", async (c) => {
  ...
  // Browser Back Button နှိပ်ရင် Cache မဖြစ်အောင် (User state မှန်အောင်)
  ...
  // 🔥 PERFORMANCE FIX: Database calls တွေကို တပြိုင်နက်တည်း ခေါ်လိုက်ပါမယ် (Promise.all)
  // အရင်ကလို တစ်ခုပြီးမှ တစ်ခုမလုပ်တော့ပါ
  const [
      sliderMovies,
      catMovies,
      catSeries,
    ...
    <Layout user={user} announcement={config.showAnnouncement ? config.announcement : undefined} lang={lang} activeTab="home">
      ...
      <div class="px-4 space-y-10 pb-8">
          {sections.map(section => { 
              ...
              // Wide Card Logic (4K Porns အတွက်ပါ ထည့်ထားသည်)
