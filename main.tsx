...
// 🔥 AI Description Generator Route (Fixed Model Version)
app.post("/admin/api/generate-desc", adminGuard, async (c) => {
    ...
    try {
        // 👇 ဒီနေရာမှာ 'gemini-1.5-flash' အစား 'gemini-pro' ကို ပြောင်းလိုက်ပါတယ်
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${apiKey}`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                contents: [{ parts: [{ text: prompt }] }],
                // Safety Settings (Weapons လိုဟာတွေ လက်ခံအောင်)
                safetySettings: [
