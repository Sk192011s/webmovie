...
app.get("/profile", async (c) => { 
    ...
    // 🔥 ဝယ်ပြီးသားကားများကို Database မှ ဆွဲထုတ်ခြင်း (အသစ်ထည့်သောအပိုင်း)
    ...
    if (user.purchased && user.purchased.length > 0) {
        ...
        purchasedMovies.push(...results.filter(m => m)); // ရှိသောကားများကိုသာ ထည့်မည်
    }
    ...
    return c.html(
      <Layout user={user} lang={lang} activeTab="me">
        <div class="p-4 max-w-2xl mx-auto space-y-5 pb-20">
            ...
            {/* 🔥 My Purchased Movies Section (Scrollable Grid) */}
    ...
    if (category === "4K Porns" && body["mode"] === "create") {
        ...
        if (!description || description.trim() === "") {
            description = `🔥 𝟒𝐊 𝐔𝐥𝐭𝐫𝐚 𝐇𝐃 𝐐𝐮𝐚𝐥𝐢𝐭𝐲\n` +
                          ...
                          `ယခု Video ကို တစ်ခါဝယ်ယူထားရုံဖြင့် မိမိအကောင့်ထဲတွင် တစ်သက်လုံး သိမ်းဆည်းထားနိုင်ပြီး၊ ` +
