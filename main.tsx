...
<form action="/report" method="post" class="mt-4 text-center">
    ...
    <button class="text-[10px] text-red-500 hover:text-red-400 font-bold underline decoration-dotted">
        <i class="fa-solid fa-flag"></i> Report Broken Link / ကြည့်မရရင် နှိပ်ပါ
    </button>
</form>
