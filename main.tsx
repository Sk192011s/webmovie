...
const i18n: any = {
    en: {
        ...
        see_all: "View All", views: "Views", dl_help: "​ေဒါင်းလော့ လုပ်နည်း",
            ...
            <div class="bg-[#1f1f1f] p-5 rounded-2xl border border-blue-900/30 relative overflow-hidden">
                 ...
                 <form action="/profile/topup" method="post" class="space-y-3">
                    <div class="flex gap-2">
                         <input type="number" name="amount" placeholder="Amount (Ks)" required class="input-box bg-black/50 text-sm" />
                         <select name="method" class="input-box bg-black/50 text-sm w-32">
