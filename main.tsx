                            ...
                            <form action="/admin/movie/save" method="post" class="space-y-4 text-sm w-full">
                                ...
                                <div class="bg-zinc-800 p-3 rounded-xl mb-2 border border-zinc-700">
                                    <div class="flex justify-between items-center mb-2">
                                        <label class="text-[10px] text-green-400 uppercase font-bold"><i class="fa-solid fa-wand-magic-sparkles"></i> Auto Generator</label>
                                        <button type="button" onclick="clearEpisodes()" class="text-[10px] text-red-400 hover:text-white underline">Clear All</button>
                                    </div>
                                    <div class="space-y-2">
                                        <input id="gen-url" placeholder="Link with ***, $$, or XX" class="input-box text-[10px] bg-black border-zinc-600 h-8" />
                                        <div class="flex gap-2">
                                            <input id="gen-season" placeholder="Season" value="1" class="input-box text-[10px] bg-black border-zinc-600 h-8 w-1/3 text-center" />
                                            <input id="gen-start" type="number" placeholder="Start" value="1" class="input-box text-[10px] bg-black border-zinc-600 h-8 w-1/3 text-center" />
                                            <input id="gen-end" type="number" placeholder="End" class="input-box text-[10px] bg-black border-zinc-600 h-8 w-1/3 text-center" />
                                        </div>
                                        <button type="button" onclick="generateEpisodes()" class="w-full bg-green-700 hover:bg-green-600 text-white text-xs font-bold py-2 rounded transition">Generate Links</button>
                                    </div>
                                    <script dangerouslySetInnerHTML={{__html: `
                                        function generateEpisodes() {
                                            ...
                                            if (!placeholder) { alert("Use *** or $$ or XX in URL!"); return; }
