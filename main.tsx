    ...
    return c.html(
      <Layout user={user}>
        <div class="p-4 max-w-4xl mx-auto space-y-6">
            ...
            {/* 1. MEMBERSHIP CARD - FIXED ASPECT RATIO */}
            <div class="relative w-full aspect-[1.7/1] rounded-2xl bg-gradient-to-br from-amber-300 via-yellow-500 to-amber-600 p-5 shadow-2xl text-black flex flex-col justify-between overflow-hidden">
                ...
                <div class="relative z-10 flex justify-between items-start">
                     <div class="flex items-center gap-3">
                         ...
                         <div>
                             <h2 class="text-xl font-black tracking-tight">{user.username}</h2>
                             <div class="text-[10px] font-bold bg-black/20 px-2 py-0.5 rounded inline-block uppercase tracking-wider">{statusText}</div>
                         </div>
                     </div>
                ...
                <div class="relative z-10 flex justify-between items-end font-mono">
                    <div>
                        <p class="text-[8px] uppercase opacity-70 font-bold mb-0.5">Member ID</p>
                        <p class="text-sm sm:text-lg font-bold tracking-widest">{memberId}</p>
                    </div>
                    <div class="text-right">
                         <p class="text-[8px] uppercase opacity-70 font-bold mb-0.5">Expires</p>
                         <p class="text-xs sm:text-sm font-bold">{premium ? `${finalDays} Days Left` : "Not Active"}</p>
                    </div>
                </div>
            </div>
    ...
    return c.html(
        <Layout title="Admin" isAdmin={true}>
            <div class="p-4 bg-zinc-900 min-h-screen">
                ...
                {/* TAB 3: USERS (UPDATED WITH MANUAL ADD VIP) */}
...
// NEW: MANUAL VIP ADD
app.post("/admin/user/add-vip", adminAuth, async (c) => { 
    ...
    if (user) { 
        ...
        return c.redirect(ADMIN_ROUTE + "/dashboard?tab=users&success=VIP Added Successfully"); 
    } 
