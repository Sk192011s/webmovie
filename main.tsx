...
// =======================
// 4. UI LAYOUT (NEW CYBER-GLASS UI WITH FIXED LOADERS)
// =======================
        ...
        document.addEventListener('DOMContentLoaded', () => {
             ...
             document.body.addEventListener('click', (e) => {
                ...
                if (link) {
                    ...
                    // Only show loader for internal links that aren't download links or anchors
                    if (href && href.startsWith('/') && !href.includes('#') && !href.includes('/dl/') && target !== '_blank' && !link.classList.contains('float-tg')) {
                        window.showLoader();
                    }
                }
             });
             ...
             window.loadPlayer = async function(content, type, movieId, title, poster, btnElement) {
                ...
                // Show Loader & Hide Cover
                if(container) container.innerHTML = ''; 
                if(cover) cover.style.display = 'none';
                if(container) container.style.display = 'block'; 
                if(loader) loader.style.display = 'flex'; // FORCE SHOW LOADER
                ...
                if(video) { 
                    // Hide loader only when video actually starts playing or has data
